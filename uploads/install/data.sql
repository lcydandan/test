...
CREATE TABLE IF NOT EXISTS `ai9me_access` (
...
--
-- 导出表中的数据 `ai9me_access`
--

INSERT INTO `ai9me_access` (`role_id`, `node_id`, `pid`, `level`, `module`) VALUES
(5, 17, 11, 3, NULL),
(5, 16, 11, 3, NULL),
(5, 15, 11, 3, NULL),
(5, 14, 11, 3, NULL),
...
CREATE TABLE IF NOT EXISTS `ai9me_adma` (
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='diy宣传页' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `ai9me_api` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `token` varchar(60) NOT NULL,
  `url` varchar(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ai9me_areply` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ai9me_article` (
...
CREATE TABLE IF NOT EXISTS `ai9me_case` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ai9me_classify` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ai9me_company` (
...
--
-- 表的结构 `ai9me_diymen_class`
--

CREATE TABLE IF NOT EXISTS `ai9me_diymen_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `pid` int(11) NOT NULL,
...
--
-- 表的结构 `ai9me_diymen_set`
--

CREATE TABLE IF NOT EXISTS `ai9me_diymen_set` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ai9me_dream` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `ai9me_dream` (`id`, `title`, `content`) VALUES
...
CREATE TABLE IF NOT EXISTS `ai9me_flash` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ai9me_function` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 导出表中的数据 `ai9me_function`
--

INSERT INTO `ai9me_function` (`id`, `gid`, `usenum`, `name`, `funname`, `info`, `isserve`, `status`) VALUES
...
CREATE TABLE IF NOT EXISTS `ai9me_home` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `title` varchar(30) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ai9me_host` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `ai9me_host_list_add`
--

CREATE TABLE IF NOT EXISTS `ai9me_host_list_add` (
...
--
-- 表的结构 `ai9me_host_order`
--

CREATE TABLE IF NOT EXISTS `ai9me_host_order` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `token` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ai9me_img` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `uname` varchar(90) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ai9me_indent` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ai9me_keyword` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `keyword` char(255) NOT NULL,
  `pid` int(11) NOT NULL,
  `token` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ai9me_links` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ai9me_lottery` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `ai9me_lottery_record`
--

CREATE TABLE IF NOT EXISTS `ai9me_lottery_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `lid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ai9me_member` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
--
-- 表的结构 `ai9me_member_card_contact`
--

CREATE TABLE IF NOT EXISTS `ai9me_member_card_contact` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
--
-- 导出表中的数据 `ai9me_member_card_contact`
--
...
--
-- 表的结构 `ai9me_member_card_coupon`
--

CREATE TABLE IF NOT EXISTS `ai9me_member_card_coupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `title` varchar(60) NOT NULL,
...
--
-- 导出表中的数据 `ai9me_member_card_coupon`
--
...
--
-- 表的结构 `ai9me_member_card_create`
--

CREATE TABLE IF NOT EXISTS `ai9me_member_card_create` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
--
-- 导出表中的数据 `ai9me_member_card_create`
--
...
--
-- 表的结构 `ai9me_member_card_exchange`
--

CREATE TABLE IF NOT EXISTS `ai9me_member_card_exchange` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
--
-- 导出表中的数据 `ai9me_member_card_exchange`
--
...
--
-- 表的结构 `ai9me_member_card_info`
--

CREATE TABLE IF NOT EXISTS `ai9me_member_card_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `info` varchar(200) NOT NULL,
...
--
-- 导出表中的数据 `ai9me_member_card_info`
--
...
--
-- 表的结构 `ai9me_member_card_integral`
--

CREATE TABLE IF NOT EXISTS `ai9me_member_card_integral` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `title` varchar(60) NOT NULL,
...
--
-- 导出表中的数据 `ai9me_member_card_integral`
--
...
--
-- 表的结构 `ai9me_member_card_set`
--

CREATE TABLE IF NOT EXISTS `ai9me_member_card_set` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
--
-- 表的结构 `ai9me_member_card_sign`
--

CREATE TABLE IF NOT EXISTS `ai9me_member_card_sign` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(50) NOT NULL,
  `wecha_id` varchar(50) NOT NULL,
...
--
-- 导出表中的数据 `ai9me_member_card_sign`
--
...
--
-- 表的结构 `ai9me_member_card_vip`
--

CREATE TABLE IF NOT EXISTS `ai9me_member_card_vip` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `title` varchar(60) NOT NULL,
  `group` tinyint(1) NOT NULL,
...
--
-- 表的结构 `ai9me_nearby_user`
--

CREATE TABLE IF NOT EXISTS `ai9me_nearby_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ai9me_node` (
...
INSERT INTO `ai9me_node` (`id`, `name`, `title`, `status`, `remark`, `pid`, `level`, `data`, `sort`, `display`) VALUES
(1, 'cms', '根节点', 1, '', 0, 1, NULL, 0, 0),
(2, 'Site', '站点管理', 1, '', 1, 0, NULL, 0, 1),
(3, 'User', '用户管理', 1, '', 1, 0, NULL, 0, 1),
(4, 'extent', '扩展管理', 1, '', 1, 0, NULL, 0, 1),
...
CREATE TABLE IF NOT EXISTS `ai9me_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `ai9me_ordering_class`
--

CREATE TABLE IF NOT EXISTS `ai9me_ordering_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
--
-- 表的结构 `ai9me_ordering_set`
--

CREATE TABLE IF NOT EXISTS `ai9me_ordering_set` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `keyword` varchar(10) NOT NULL,
  `title` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ai9me_other` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ai9me_photo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `title` varchar(20) NOT NULL,
  `picurl` varchar(100) NOT NULL,
...
--
-- 表的结构 `ai9me_photo_list`
--

CREATE TABLE IF NOT EXISTS `ai9me_photo_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `pid` int(11) NOT NULL,
  `title` varchar(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ai9me_product` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `ai9me_product_cart`
--

CREATE TABLE IF NOT EXISTS `ai9me_product_cart` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `token` varchar(50) NOT NULL DEFAULT '',
...
--
-- 表的结构 `ai9me_product_cart_list`
--

CREATE TABLE IF NOT EXISTS `ai9me_product_cart_list` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- 导出表中的数据 `ai9me_product_cart_list`
--
...
--
-- 表的结构 `ai9me_product_cat`
--

CREATE TABLE IF NOT EXISTS `ai9me_product_cat` (
...
--
-- 表的结构 `ai9me_product_diningtable`
--

CREATE TABLE IF NOT EXISTS `ai9me_product_diningtable` (
  `id` mediumint(4) NOT NULL AUTO_INCREMENT,
  `token` varchar(50) NOT NULL DEFAULT '',
...
--
-- 导出表中的数据 `ai9me_product_diningtable`
--
...
--
-- 表的结构 `ai9me_reply_info`
--

CREATE TABLE IF NOT EXISTS `ai9me_reply_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
...
--
-- 表的结构 `ai9me_requestdata`
--

CREATE TABLE IF NOT EXISTS `ai9me_requestdata` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `year` int(4) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ai9me_role` (
  `id` smallint(6) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `ai9me_role` (`id`, `name`, `pid`, `status`, `sort`, `remark`) VALUES
(1, '超级管理员', 0, 1, 0, ''),
(2, '演示组', 0, 1, 0, ''),
(3, '普通会员', 0, 1, 0, '');
...
--
-- 表的结构 `ai9me_role_user`
--

CREATE TABLE IF NOT EXISTS `ai9me_role_user` (
...
CREATE TABLE IF NOT EXISTS `ai9me_selfform` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `ai9me_selfform_input`
--

CREATE TABLE IF NOT EXISTS `ai9me_selfform_input` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `ai9me_selfform_value`
--

CREATE TABLE IF NOT EXISTS `ai9me_selfform_value` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `formid` int(10) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ai9me_snccode` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` int(1) NOT NULL,
  `status` int(1) NOT NULL,
...
--
-- 表的结构 `ai9me_system_info`
--

CREATE TABLE IF NOT EXISTS `ai9me_system_info` (
  `lastsqlupdate` int(10) NOT NULL,
  `version` varchar(10) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- 导出表中的数据 `ai9me_system_info`
--
...
CREATE TABLE IF NOT EXISTS `ai9me_taobao` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ai9me_text` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `uname` varchar(90) NOT NULL,
  `keyword` char(255) NOT NULL,
...
--
-- 表的结构 `ai9me_token_open`
--

CREATE TABLE IF NOT EXISTS `ai9me_token_open` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `token` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ai9me_user` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ai9me_userinfo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `wecha_id` varchar(60) NOT NULL,
  `wechaname` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ai9me_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `gid` int(11) NOT NULL,
...
--
-- 表的结构 `ai9me_user_group`
--

CREATE TABLE IF NOT EXISTS `ai9me_user_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 导出表中的数据 `ai9me_user_group`
--

INSERT INTO `ai9me_user_group` (`id`, `name`, `diynum`, `connectnum`, `iscopyright`, `activitynum`, `price`, `statistics_user`, `create_card_num`, `status`, `wechat_card_num`) VALUES
...
--
-- 表的结构 `ai9me_user_request`
--

CREATE TABLE IF NOT EXISTS `ai9me_user_request` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(30) NOT NULL,
  `uid` varchar(32) NOT NULL,
  `keyword` varchar(100) NOT NULL,
...
--
-- 表的结构 `ai9me_voiceresponse`
--

CREATE TABLE IF NOT EXISTS `ai9me_voiceresponse` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `uname` varchar(90) NOT NULL,
  `createtime` varchar(13) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ai9me_weather` (
...
--
-- 导出表中的数据 `ai9me_weather`
--

INSERT INTO `ai9me_weather` (`id`, `code`, `name`) VALUES
(1, '101010100', '北京'),
(2, '101010200', '海淀'),
(3, '101010400', '顺义'),
(4, '101010500', '怀柔'),
...
--
-- 表的结构 `ai9me_wecha_user`
--

CREATE TABLE IF NOT EXISTS `ai9me_wecha_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token` varchar(60) NOT NULL,
  `wecha_id` varchar(60) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ai9me_wxuser` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
